...
class RealTimeCurrencyConverter:
    ...
    def convert(self, from_currency, to_currency, amount):
        ...
        if from_currency != 'USD':
            amount = amount / self.currencies.get(from_currency, 1)
        amount = round(amount * self.currencies.get(to_currency, 1), 4)
        return amount
...
class App(tk.Tk):
    def __init__(self, converter):
        ...
        self.intro_label.place(x=10, y=15)
        ...
        # Placing
        self.from_currency_dropdown.place(x=30, y=60)
        self.amount_field.place(x=36, y=100)
        self.to_currency_dropdown.place(x=340, y=60)
    ...
    def perform(self):
        try:
            ...
            self.converted_amount_field_label.config(text="API Error!")
            print(f"Error: {e}")
